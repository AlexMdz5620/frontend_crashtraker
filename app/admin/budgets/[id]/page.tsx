...
import { formatCurrency, formatDate } from '@/src/utlis';
...
export default async function BudgetDetailsPage({ params }: { params: { id: string } }) {
    ...
    const totalAvailabe = +budget.amount - totalSpent;
            ...
            {budget.expenses.length
                ? (
                    <>
                        ...
                        <h1 className='font-black text-4xl text-purple-800'>
                            Gastos en este presupuesto
                        </h1>

                        <ul role="list" className="divide-y bg-gray-300 border shadow-lg mt-10 ">
